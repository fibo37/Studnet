...
public class ListUser extends ListActivity {
    ...
    // testing on Emulator:
    private static final String READ_COMMENTS_URL = "http://iucommunity.info/test/user.php";
    ...
    private static final String TAG_POSTS = "user";
    ...
    */
    ...
    private void updateList() {
        ...
        ListAdapter adapter = new SimpleAdapter(this, mCommentList,
                R.layout.activity_singleuser, new String[] { TAG_ID, TAG_USERNAME }, new int[] { R.id.id, R.id.username });
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(ListUser.this, UserProfile.class);
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ListUser.this);
