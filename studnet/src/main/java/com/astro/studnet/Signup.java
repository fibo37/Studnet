...
import static com.astro.studnet.R.id.male;


public class Signup extends ActionBarActivity implements OnClickListener {

    private EditText user, pass, first, last, email, phone;
    ...
    //testing on Emulator:
    private static final String LOGIN_URL = "http://iucommunity.info/test/register.php";
        ...
        protected String doInBackground(String... args) {
            ...
            if (isInternetPresent) {
                ...
                try {
                    ...
                    params.add(new BasicNameValuePair("male", mmale));
